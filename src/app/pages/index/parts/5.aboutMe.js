...
let params = {
  'displayName': 'Reorder block',
  'blockID': 'reorderBlock'
};
...
function aboutMe() {
  return (
    <div
      id={params.blockID}
      key={params.blockID}
      className="container-fluid aboutme bg-light text-center p-md-5 pb-sm-5 pt-sm-5"
      style={{
      'backgroundImage': `url(${dustBG})`
    }}>
      <h2 className="col-md-6 offset-md-3 mb-5">Dont like the order of blocks? Re-order!</h2>
      <h5>Idk why I did this. Now I dont want to delete it :)</h5>
      <div className="row">
